...
# --- Endpoints (ML Model Prediction & LLM Insights) ---
@app.get("/")
def home():
...
def predict(finance_data: FinanceInput):
    ...
    try:
        ...
        try:
            llm_model = genai.GenerativeModel(ACTIVE_MODEL_NAME)
            ...
            # Fallback if the LLM fails, ensuring the frontend doesn't crash
            llm_data = {
